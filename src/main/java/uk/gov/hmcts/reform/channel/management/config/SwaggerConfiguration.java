...
import uk.gov.hmcts.reform.channel.management.Application;
...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("P&I Channel Management Service")
            .description(
                "Use this service to Support and management of various channels that may receive publication services. "
                    + "You can find out more about how the code works at "
                    + "https://github.com/hmcts/pip-channel-management")
            .version("1.0.0")
            .contact(new Contact(
                "P&I Team",
