...
class PrimaryHealthListFileConverterTest {
    ...
    void testSuccessfulConversion() throws IOException {
        ...
        JsonNode input = getInput("/mocks/primaryHealthList.json");
    ...
    private Map<String, Object> handleLanguage() throws IOException {
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader().getResourceAsStream("templates/languages/en/primaryHealthList.json")) {
