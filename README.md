# Publication and Information - Channel Management

[![Build Status](https://travis-ci.org/hmcts/spring-boot-template.svg?branch=master)](https://travis-ci.org/hmcts/spring-boot-template)

## Purpose

The purpose of this service is to provide the ability to manage subscriber channels (Email/Api) and different publication channels (PDF/Excel).
...
The application exposes health endpoint (http://localhost:8181/health) and metrics endpoint
...
(set to `8181` in this template app).
